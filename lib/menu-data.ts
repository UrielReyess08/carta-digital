...
export const menuData: MenuItem[] = [
  ...
  // CAFÉ 10oz
  { id: "cafe-americano-10", name: "Americano", price: 4.00, category: "CAFÉ 10oz", description: "Café espresso diluido en agua caliente", image: "/Cafe10/Americano.webp", sweetenerOptions: ["Azúcar", "Stevia"], temperatureOptions: ["Caliente", "Frío"] },
  { id: "cafe-espresso-10", name: "Espresso", price: 4.00, category: "CAFÉ 10oz", description: "Shot de café puro concentrado", image: "/Cafe10/Espress.webp", sweetenerOptions: ["Azúcar", "Stevia"], temperatureOptions: ["Caliente", "Frío"] },
  ...
  { id: "cafe-mocaccino-10", name: "Mocaccino", price: 5.00, category: "CAFÉ 10oz", description: "Mezcla de café espresso, chocolate y leche", image: "/Cafe10/Mocacci.webp", sweetenerOptions: ["Azúcar", "Stevia"], temperatureOptions: ["Caliente", "Frío"] },
  { id: "cafe-winter-summer-10", name: "Winter / Summer Coffee", price: 6.00, category: "CAFÉ 10oz", description: "Café americano cubierto con una capa de crema batida", image: "/Cafe10/WinterSummerCoffee.webp", sweetenerOptions: ["Azúcar", "Stevia"], temperatureOptions: ["Caliente", "Frío"] },
  ...
  // FROZEN 12oz
  { id: "frozen-fresa-12", name: "Frozen de Fresa", price: 10.00, category: "FROZEN 12oz", description: "Bebida súper refrescante hecha a base de pura pulpa de fruta y abundante hielo triturado", image: "/Frozen/FrozenFre.webp", sweetenerOptions: ["Azúcar", "Stevia"] },
  { id: "frozen-lucuma-12", name: "Frozen de Lúcuma", price: 10.00, category: "FROZEN 12oz", description: "Bebida súper refrescante hecha a base de pura pulpa de fruta y abundante hielo triturado", image: "/Frozen/FrozenLucu.webp", sweetenerOptions: ["Azúcar", "Stevia"] },
  { id: "frozen-mango-12", name: "Frozen de Mango", price: 10.00, category: "FROZEN 12oz", description: "Bebida súper refrescante hecha a base de pura pulpa de fruta y abundante hielo triturado", image: "/Frozen/FrozenMan.webp", sweetenerOptions: ["Azúcar", "Stevia"] },
  { id: "frozen-arandano-12", name: "Frozen de Arándano", price: 10.00, category: "FROZEN 12oz", description: "Bebida súper refrescante hecha a base de pura pulpa de fruta y abundante hielo triturado", image: "/Frozen/FrozenAran.webp", sweetenerOptions: ["Azúcar", "Stevia"] },
  { id: "frozen-maracuya-12", name: "Frozen de Maracuyá", price: 10.00, category: "FROZEN 12oz", description: "Explosión cítrica y refrescante, ideal para los días de sol", image: "/Frozen/FrozenMara.webp", sweetenerOptions: ["Azúcar", "Stevia"] },
  { id: "frozen-frambuesa-12", name: "Frozen de Frambuesa", price: 11.00, category: "FROZEN 12oz", description: "Granizado intenso con el sabor silvestre y refrescante de las frambuesas", image: "/Frozen/FrozenFram.webp", sweetenerOptions: ["Azúcar", "Stevia"] },
